...
select mmi_master.gstndata_street_final('street_raw_data','raw_street_basti','285','10','basti','15825',
										'mmi_master_road','UP_ROAD_NETWORK','street_output_data','BASTI_ADDR_ADMIN_R')


CREATE OR REPLACE FUNCTION mmi_master.gstndata_street_final(
	...
	outputschema text ,
	admin_addr_table text DEFAULT 0)
    RETURNS text
    LANGUAGE 'plpgsql'
...
EXECUTE SQLQuery;
		...
		RAISE INFO 'SQL_STATEMENT:%',master_db_table;
